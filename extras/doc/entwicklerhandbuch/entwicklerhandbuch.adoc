...
= Entwickler/innen/handfilm
 Hannah Haeusler <haha1017@h-ka.de>, Hai-Mi Nguyen <ngha1011@h-ka.de>, Dinh Thien Phan <phdi1011@h-ka.de>, Achim Seelhorst <seac1011@h-ka.de> 
:doctype: book
:toc: left
:sectanchors:
:sectlinks:
...
[plantuml,FilmController,svg]
----
include::FilmController.puml[]
----
...
[plantuml,FilmResolver,svg]
----
include::FilmResolver.puml[]
----
